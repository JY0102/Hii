...
int main(){
 ...
 for (a = 0; a < 6; a++) {
        hello(a);
        Scan_info(member_info[a], age);        // 입력 값 6개를 받기
    }


 for (a = 0; a < 6; a++) {
        Out_info(member_info[a], age);        //  값 6개를 출력
    }
...
void Scan_info(char* candidate,char* age){                  //후보자 데이터 입력 
